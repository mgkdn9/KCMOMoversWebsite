...
try {
    ...
    //Exit script -->
    echo "<a href='/KCMOMoversWebsite/index.html'>Back to Form</a>";
    // header("Location: /KCMOMoversWebsite/index.html");
    // exit();
    echo "<script>window.location = '/KCMOMoversWebsite/index.html#send_message_container';</script>";
